...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Vector3 kRotate{ 0.0f,0.0f,0.0f };
	Vector3 kTranslate{ 0.0f,0.0f,0.0f };
	...
	Vector3 kLocalVertices[3]{{-0.5f,-0.5f,0.0f}, {0.0f,0.5f,0.0f}, {0.5f,-0.5f,0.0f}};
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Matrix4x4 worldMatrix = MakeAffineMatrix({ 1.0f,1.0f,1.0f }, kRotate, kTranslate);
